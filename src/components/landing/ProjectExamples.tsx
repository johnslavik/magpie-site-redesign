...
export function ProjectRules() {
  return <div className="project-procedures project-adaptation">
    ...
    <div className="adapted-procedures"><div className="project-identity" aria-label="Adapt Magpie to an Airflow maintainer’s project"><Users size={30} /><img src="/vendor-logos/airflow.svg" alt="Apache Airflow" width="100" /><span aria-hidden="true">+</span><img className="project-magpie" src="/favicon.svg" alt="Magpie customized for your project" width="40" /></div>
      ...
      <p>Teach your agent how your project works by saving your review rules, conventions, and lessons in Magpie’s skills. You choose what changes and what carries forward.</p>
