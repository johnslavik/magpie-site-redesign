      ...
      <div className="reel-example" key={selected}>
          <div className="reel-active">
            <ol className="reel-flow">
              ...
              <li className="reel-process"><img className="process-wordmark" src={withBase("/wordmark.svg")} alt="Magpie" width="118" height="34" /><small className="prepared-workflow-label">Been there. Done that.<span className="workflow-reuse">Now a workflow your agent can reuse.</span></small><ul className="reel-work">{item.work.map(step => <li key={step}><span aria-hidden="true">✓</span>{step}</li>)}</ul></li>
